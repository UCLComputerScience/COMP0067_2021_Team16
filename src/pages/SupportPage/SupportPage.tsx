    ...
    <IonPage>
      <IonContent fullscreen>
        ...
        <IonModal isOpen={showModal1} cssClass="my-custom-class">
          <p>
            ...
            <li>
              ...
              and infant development is on-going in the world’s top neonatal
              unit. Images are designed to assist specific stages of development
        ...
        <IonButton onClick={() => setShowModal2(true)}>
          Cosmic Baby Books (cosmicbabybooks.com)
        </IonButton>
        ...
        <IonModal isOpen={showModal3} cssClass="my-custom-class">
          <p>
            ...
            effective decisions. Iya is a public speaker and presenter on radio
            and TV, for example, in BBC Science TV series with Astronaut Chris
            Hadfield and Dr Kevin Fong presenter, BBC Astronauts: Do you have
            what it takes?'. Iya runs workshops for public and academic.
          </p>
        ...
        <IonButton onClick={() => setShowModal3(true)}>
          Dr Iya Whiteley (www.iyawhiteley.com)
        </IonButton>
