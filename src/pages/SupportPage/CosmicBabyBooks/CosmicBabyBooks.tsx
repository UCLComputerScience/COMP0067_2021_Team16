    ...
    <IonPage>
          ...
          <IonGrid>
            <IonRow>
              ...
              <IonCol size="8" className="title">
                <IonTitle>Cosmic Baby Books</IonTitle>
              </IonCol>
              <IonCol />
            </IonRow>
          </IonGrid>
      ...
      <IonText>
        <h4>
          ...
          children to introduce newborn babies to our beautiful Earth. <br />
          Images represent the intricate beauty of our natural world, our human
