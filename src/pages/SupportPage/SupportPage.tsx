          ...
          <IonModal isOpen={showModal1} cssClass="my-custom-class">
            <p>
              ...
              <li>
                ...
                interaction. Children have more brain pathways than adults.
                Brain pathways die way if they are not used. Further research on
                newborn and infant development is on-going in the world’s top
                neonatal unit. Images are designed to assist specific stages of
                development during the first year. Look out for apps for four
        ...
        <IonRow className="modalrow ion-align-items-center ion-justify-content-center">
          <IonModal isOpen={showModal3} cssClass="my-custom-class">
            <p>
              ...
              Psychologist, she specialises in visual perception and design
              displays for highly skilled military pilots and astronauts. These
              top performers need to absorb information instantly and make
              effective decisions. Iya is a public speaker and presenter on
              radio and TV, for example, in BBC Science TV series with Astronaut
              Chris Hadfield and Dr Kevin Fong presenter, BBC Astronauts: Do you
              have what it takes?'. Iya runs workshops for public and academic.
