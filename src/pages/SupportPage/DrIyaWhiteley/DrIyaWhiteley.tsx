...
const DrIyaWhiteley: React.FC = () => {
    return(
        <IonPage>
          ...
          <img src={process.env.PUBLIC_URL + 'assets/images/authors.png'} alt="Dr. Iya Whiteley" />
          ...
          <h4>
                ...
                European Astronaut Centre in Germany. <br/><br/>As a <b>Cognitive Engineer
                and Clinical Psychologist</b>, she specialises in visual perception
                and design displays for highly skilled military pilots and
                astronauts. These top performers need to absorb information
                instantly and make effective decisions. <br/><br/>Iya is a public speaker
