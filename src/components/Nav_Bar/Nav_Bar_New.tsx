...
const Nav_Bar_New: React.FC = () => (
  <IonGrid className="ion-grid">
    <IonRow>
      <IonCol className="ion-column"><IonButton fill="clear" className="ion-button"><IonIcon icon={person} size="large" /></IonButton></IonCol>
      <IonCol className="ion-column"><IonButton fill="clear"><IonIcon icon={musicalNotes} size="large" /></IonButton></IonCol>
      <IonCol className="ion-column"><IonButton fill="clear"><IonIcon icon={desktop} size="large" /></IonButton></IonCol>
      <IonCol className="ion-column"><IonButton fill="clear"><IonIcon icon={informationCircle} size="large" /></IonButton></IonCol>
    </IonRow>
  </IonGrid>
);
